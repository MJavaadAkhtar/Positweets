...
from .api import UserViewSet,LoginUser,UserViewSetTest,postBlogs,getBlogs,BlogViewSet,getBlogsUser,getUsers
...
urlpatterns = [
    ...
    url('api/getUserBlog', getBlogsUser.as_view()),
    url('api/user/(?P<username>\w+)/$', getUsers.as_view())
]
